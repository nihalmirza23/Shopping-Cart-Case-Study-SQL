...
public class EWalletController  {
	...
	public EWallet addWallet(@RequestBody EWallet ewallet,
			@PathVariable("userId") int userId,
			@RequestHeader(HttpHeaders.AUTHORIZATION)String headers) {
		// TODO Auto-generated method stub
		logger.trace("add wallet method accessed");
		return walletServiceImpl.addWallet(ewallet,userId,headers);
	}
	...
	public EWallet removeMoney(@PathVariable("walletId") int walletId,
			@PathVariable("amount") Double amount) {
		// TODO Auto-generated method stub
	...
	/*
	 * @GetMapping("/pay/byWallet/{orderId}/{walletId}") public StatementDto
	 * payUsingWallet(@PathVariable("orderId")String
	 * orderId,@PathVariable("walletId") String walletId) { return
	 * walletServiceImpl.payUsingWallet(orderId, walletId); }
	 */
