...
//	//private final double productPrice=500D;
//	
//
//	@BeforeEach
//	void setUp() {
...
//	
//  //  @Test
//   //	void addCartProductNameNotNull() {
//   	//	assertNotNull(cart.getProductName(), "Product name is required");
//   	//}
//	
//	
//    @Test
...
//
// //   @Test
//  // 	void addCartProductPriceNotNull() {
//  // 		assertNotNull(cart.getProductPrice(), "product price is required");
// //  	}
//    
//    @Test
...
//  //  @Test
//    //void addCartCheck() {
//    //	when(cartServiceImpl.AddCart(cart, userId, productName)).thenReturn(cart);
//    //	Cart cartRest=cartController.AddCart(cart, userId, productName);
...
//   // }
//   // @Test
//  //  void addCartProductNameCheck() {
//    //	when(cartServiceImpl.AddCart(cart, userId, productName)).thenReturn(cart);
//    //	Cart cartRest=cartController.AddCart(cart, userId, productName);
//    	//assertEquals(cart.getProductName(), cartRest.getProductName());
//   // }
//    
// //   @Test
// //   void addCartProductPriceCheck() {
//   // 	when(cartServiceImpl.AddCart(cart, userId, productName)).thenReturn(cart);
//    //	Cart cartRest=cartController.AddCart(cart, userId, productName);
//    //	assertEquals(cart.getProductPrice(), cartRest.getProductPrice());
//  //  }
//  //  @Test
