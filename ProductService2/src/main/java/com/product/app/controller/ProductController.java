...
public class ProductController {
	...
	@PostMapping("/allproducts/{merchantId}/{categoryId}")
	@ApiOperation(value = "Inserts product details",
	notes = "registers on shopping cart website",
	response = List.class)
	public List<Product> addProducts(@RequestBody List<Product> product ,@PathVariable ("merchantId") int merchantId,
			@PathVariable("categoryId")int categoryId) {
	   
		return productServiceImpl.addAllProducts(product , merchantId, categoryId);
	...
	//Get product by Category
	@GetMapping("/allproduct/bycategoryid/{categoryId}")
